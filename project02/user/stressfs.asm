...
main(int argc, char *argv[])
{
  ...
  1a:	9ba78793          	addi	a5,a5,-1606 # 9d0 <thread_join+0x60>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	97450513          	addi	a0,a0,-1676 # 9a0 <thread_join+0x30>
  ...
  60:	95c50513          	addi	a0,a0,-1700 # 9b8 <thread_join+0x48>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	92e50513          	addi	a0,a0,-1746 # 9c8 <thread_join+0x58>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 432:	5ea50513          	addi	a0,a0,1514 # a18 <digits>
 436:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c8:	354b8b93          	addi	s7,s7,852 # a18 <digits>
 ...
 716:	2ce90913          	addi	s2,s2,718 # 9e0 <thread_join+0x70>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 92c:	ef3ff0ef          	jal	81e <malloc>
  ...
  if (stack == 0) {
 930:	c105                	beqz	a0,950 <thread_create+0x3a>
 932:	86aa                	mv	a3,a0
 ...
 936:	85ca                	mv	a1,s2
 938:	8526                	mv	a0,s1
 93a:	aa9ff0ef          	jal	3e2 <clone>

  if (tid < 0) {
 93e:	02054163          	bltz	a0,960 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 954:	09850513          	addi	a0,a0,152 # 9e8 <thread_join+0x78>
 958:	e13ff0ef          	jal	76a <printf>
    return -1;
 95c:	557d                	li	a0,-1
 95e:	b7d5                	j	942 <thread_create+0x2c>
    printf("clone failed\n");
 960:	00000517          	auipc	a0,0x0
 964:	0a850513          	addi	a0,a0,168 # a08 <thread_join+0x98>
 968:	e03ff0ef          	jal	76a <printf>
    return -1;
 96c:	557d                	li	a0,-1
 96e:	bfd1                	j	942 <thread_create+0x2c>

0000000000000970 <thread_join>:

int thread_join(){
 970:	7179                	addi	sp,sp,-48
 972:	f406                	sd	ra,40(sp)
 974:	f022                	sd	s0,32(sp)
 ...
 978:	1800                	addi	s0,sp,48
  ...
  int pid = join(&stack);
 97a:	fd840513          	addi	a0,s0,-40
 97e:	a6dff0ef          	jal	3ea <join>

  if (pid < 0)
 982:	00054d63          	bltz	a0,99c <thread_join+0x2c>
 986:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 988:	fd843503          	ld	a0,-40(s0)
 98c:	e11ff0ef          	jal	79c <free>
 ...
 99a:	8082                	ret
    return -1;
 99c:	54fd                	li	s1,-1
 99e:	bfcd                	j	990 <thread_join+0x20>
