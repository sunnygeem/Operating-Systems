...
forktest(void)
{
  ...
  36:	3be50513          	addi	a0,a0,958 # 3f0 <join+0x8>
  ...
  58:	3ec50513          	addi	a0,a0,1004 # 440 <join+0x58>
  ...
  6e:	39650513          	addi	a0,a0,918 # 400 <join+0x18>
  ...
  80:	39c50513          	addi	a0,a0,924 # 418 <join+0x30>
  ...
  b0:	38450513          	addi	a0,a0,900 # 430 <join+0x48>
