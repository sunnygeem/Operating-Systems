...
main(int argc, char *argv[])
{
  ...
  34:	920a8a93          	addi	s5,s5,-1760 # 950 <thread_join+0x3e>
  ...
  6a:	8f258593          	addi	a1,a1,-1806 # 958 <thread_join+0x46>
  6e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	5c850513          	addi	a0,a0,1480 # 998 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66a:	332b8b93          	addi	s7,s7,818 # 998 <digits>
 ...
 6b8:	2ac90913          	addi	s2,s2,684 # 960 <thread_join+0x4e>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 8ce:	ef3ff0ef          	jal	7c0 <malloc>
  ...
  if (stack == 0) {
 8d2:	c105                	beqz	a0,8f2 <thread_create+0x3a>
 8d4:	86aa                	mv	a3,a0
 ...
 8d8:	85ca                	mv	a1,s2
 8da:	8526                	mv	a0,s1
 8dc:	aa9ff0ef          	jal	384 <clone>

  if (tid < 0) {
 8e0:	02054163          	bltz	a0,902 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 8f6:	07650513          	addi	a0,a0,118 # 968 <thread_join+0x56>
 8fa:	e13ff0ef          	jal	70c <printf>
    return -1;
 8fe:	557d                	li	a0,-1
 900:	b7d5                	j	8e4 <thread_create+0x2c>
    printf("clone failed\n");
 902:	00000517          	auipc	a0,0x0
 906:	08650513          	addi	a0,a0,134 # 988 <thread_join+0x76>
 90a:	e03ff0ef          	jal	70c <printf>
    return -1;
 90e:	557d                	li	a0,-1
 910:	bfd1                	j	8e4 <thread_create+0x2c>

0000000000000912 <thread_join>:
...
int thread_join(){
 ...
 91a:	1800                	addi	s0,sp,48
  //printf("thread join executed\n");
  void *stack;

  int pid = join(&stack);
 91c:	fd840513          	addi	a0,s0,-40
 920:	a6dff0ef          	jal	38c <join>

  if (pid < 0)
 924:	00054d63          	bltz	a0,93e <thread_join+0x2c>
 928:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 92a:	fd843503          	ld	a0,-40(s0)
 92e:	e11ff0ef          	jal	73e <free>
 ...
 93c:	8082                	ret
    return -1;
 93e:	54fd                	li	s1,-1
 940:	bfcd                	j	932 <thread_join+0x20>
