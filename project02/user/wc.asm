...
wc(int fd, char *name)
{
  ...
  3c:	9f8a0a13          	addi	s4,s4,-1544 # a30 <thread_join+0x3c>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9aa50513          	addi	a0,a0,-1622 # a48 <thread_join+0x54>
  ...
  cc:	97050513          	addi	a0,a0,-1680 # a38 <thread_join+0x44>
...
main(int argc, char *argv[])
{
 ...
 136:	95e58593          	addi	a1,a1,-1698 # a90 <thread_join+0x9c>
 13a:	4501                	li	a0,0
 ...
 14e:	90e50513          	addi	a0,a0,-1778 # a58 <thread_join+0x64>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b6:	5f650513          	addi	a0,a0,1526 # aa8 <digits>
 4ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 74c:	360b8b93          	addi	s7,s7,864 # aa8 <digits>
 ...
 79a:	2da90913          	addi	s2,s2,730 # a70 <thread_join+0x7c>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 9b0:	ef3ff0ef          	jal	8a2 <malloc>
  ...
  if (stack == 0) {
 9b4:	c105                	beqz	a0,9d4 <thread_create+0x3a>
 9b6:	86aa                	mv	a3,a0
 ...
 9ba:	85ca                	mv	a1,s2
 9bc:	8526                	mv	a0,s1
 9be:	aa9ff0ef          	jal	466 <clone>

  if (tid < 0) {
 9c2:	02054163          	bltz	a0,9e4 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 9d8:	0a450513          	addi	a0,a0,164 # a78 <thread_join+0x84>
 9dc:	e13ff0ef          	jal	7ee <printf>
    return -1;
 9e0:	557d                	li	a0,-1
 9e2:	b7d5                	j	9c6 <thread_create+0x2c>
    printf("clone failed\n");
 9e4:	00000517          	auipc	a0,0x0
 9e8:	0b450513          	addi	a0,a0,180 # a98 <thread_join+0xa4>
 9ec:	e03ff0ef          	jal	7ee <printf>
    return -1;
 9f0:	557d                	li	a0,-1
 9f2:	bfd1                	j	9c6 <thread_create+0x2c>

00000000000009f4 <thread_join>:

int thread_join(){
 9f4:	7179                	addi	sp,sp,-48
 9f6:	f406                	sd	ra,40(sp)
 9f8:	f022                	sd	s0,32(sp)
 9fa:	ec26                	sd	s1,24(sp)
 ...
 a02:	a6dff0ef          	jal	46e <join>

  if (pid < 0)
 a06:	00054d63          	bltz	a0,a20 <thread_join+0x2c>
 a0a:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 a0c:	fd843503          	ld	a0,-40(s0)
 a10:	e11ff0ef          	jal	820 <free>
 ...
 a1e:	8082                	ret
    return -1;
 a20:	54fd                	li	s1,-1
 a22:	bfcd                	j	a14 <thread_join+0x20>
