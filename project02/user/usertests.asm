...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	49a78793          	addi	a5,a5,1178 # 74a8 <thread_join+0x23fa>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	07a50513          	addi	a0,a0,122 # 50e0 <thread_join+0x32>
      ...
      94:	8082                	ret
{
      ...
      a4:	06050513          	addi	a0,a0,96 # 5100 <thread_join+0x52>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	05850513          	addi	a0,a0,88 # 5118 <thread_join+0x6a>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	06250513          	addi	a0,a0,98 # 5138 <thread_join+0x8a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	02e50513          	addi	a0,a0,46 # 5120 <thread_join+0x72>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	04250513          	addi	a0,a0,66 # 5148 <thread_join+0x9a>
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	ff450513          	addi	a0,a0,-12 # 5170 <thread_join+0xc2>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	fea50513          	addi	a0,a0,-22 # 5190 <thread_join+0xe2>
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	f7450513          	addi	a0,a0,-140 # 51b8 <thread_join+0x10a>
     24c:	085040ef          	jal	4ad0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	f64a8a93          	addi	s5,s5,-156 # 51b8 <thread_join+0x10a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	f0650513          	addi	a0,a0,-250 # 51c8 <thread_join+0x11a>
     ...
     2e0:	f0c50513          	addi	a0,a0,-244 # 51e8 <thread_join+0x13a>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	f0250513          	addi	a0,a0,-254 # 5200 <thread_join+0x152>
     306:	7ca040ef          	jal	4ad0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	ef298993          	addi	s3,s3,-270 # 5200 <thread_join+0x152>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	eb650513          	addi	a0,a0,-330 # 5200 <thread_join+0x152>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	e2a58593          	addi	a1,a1,-470 # 5188 <thread_join+0xda>
     366:	73a040ef          	jal	4aa0 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	eb050513          	addi	a0,a0,-336 # 5220 <thread_join+0x172>
    ...
    exit(1);
     ...
     386:	e8650513          	addi	a0,a0,-378 # 5208 <thread_join+0x15a>
    ...
    printf("open junk failed\n");
     ...
     398:	e7450513          	addi	a0,a0,-396 # 5208 <thread_join+0x15a>
  ...
  unlink("junk");
     ...
     3b0:	e5450513          	addi	a0,a0,-428 # 5200 <thread_join+0x152>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	01878793          	addi	a5,a5,24 # 74a8 <thread_join+0x23fa>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	d72a0a13          	addi	s4,s4,-654 # 5230 <thread_join+0x182>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	cf450513          	addi	a0,a0,-780 # 5238 <thread_join+0x18a>
     ...
     55e:	cf650513          	addi	a0,a0,-778 # 5250 <thread_join+0x1a2>
     ...
     574:	d1050513          	addi	a0,a0,-752 # 5280 <thread_join+0x1d2>
     ...
     586:	d2e50513          	addi	a0,a0,-722 # 52b0 <thread_join+0x202>
     ...
     59c:	d2850513          	addi	a0,a0,-728 # 52c0 <thread_join+0x212>
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	eea78793          	addi	a5,a5,-278 # 74a8 <thread_join+0x23fa>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	cfea0a13          	addi	s4,s4,-770 # 52f0 <thread_join+0x242>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	b8ea8a93          	addi	s5,s5,-1138 # 5188 <thread_join+0xda>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	c7a50513          	addi	a0,a0,-902 # 52f8 <thread_join+0x24a>
     ...
     698:	c7c50513          	addi	a0,a0,-900 # 5310 <thread_join+0x262>
     ...
     6aa:	c0a50513          	addi	a0,a0,-1014 # 52b0 <thread_join+0x202>
     ...
     6bc:	c8850513          	addi	a0,a0,-888 # 5340 <thread_join+0x292>
     ...
     6d2:	c8a50513          	addi	a0,a0,-886 # 5358 <thread_join+0x2aa>
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	a7c50513          	addi	a0,a0,-1412 # 5170 <thread_join+0xc2>
     6fc:	3d4040ef          	jal	4ad0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	a6c50513          	addi	a0,a0,-1428 # 5170 <thread_join+0xc2>
     70c:	3b4040ef          	jal	4ac0 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	a6c58593          	addi	a1,a1,-1428 # 5180 <thread_join+0xd2>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	a4850513          	addi	a0,a0,-1464 # 5170 <thread_join+0xc2>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	a2450513          	addi	a0,a0,-1500 # 5170 <thread_join+0xc2>
     754:	36c040ef          	jal	4ac0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	a1450513          	addi	a0,a0,-1516 # 5170 <thread_join+0xc2>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	c5a58593          	addi	a1,a1,-934 # 53e8 <thread_join+0x33a>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	9ac50513          	addi	a0,a0,-1620 # 5170 <thread_join+0xc2>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b9050513          	addi	a0,a0,-1136 # 5388 <thread_join+0x2da>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b9c50513          	addi	a0,a0,-1124 # 53a8 <thread_join+0x2fa>
     814:	694040ef          	jal	4ea8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b9c50513          	addi	a0,a0,-1124 # 53b8 <thread_join+0x30a>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	ba850513          	addi	a0,a0,-1112 # 53d8 <thread_join+0x32a>
     838:	670040ef          	jal	4ea8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	b7850513          	addi	a0,a0,-1160 # 53b8 <thread_join+0x30a>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b9a50513          	addi	a0,a0,-1126 # 53f0 <thread_join+0x342>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	ba450513          	addi	a0,a0,-1116 # 5410 <thread_join+0x362>
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b9850513          	addi	a0,a0,-1128 # 5430 <thread_join+0x382>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	bac98993          	addi	s3,s3,-1108 # 5458 <thread_join+0x3aa>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	bdca8a93          	addi	s5,s5,-1060 # 5490 <thread_join+0x3e2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	b4250513          	addi	a0,a0,-1214 # 5430 <thread_join+0x382>
  ...
  if(unlink("small") < 0){
     ...
     922:	b1250513          	addi	a0,a0,-1262 # 5430 <thread_join+0x382>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	af450513          	addi	a0,a0,-1292 # 5438 <thread_join+0x38a>
    ...
    exit(1);
     ...
     95e:	b0e50513          	addi	a0,a0,-1266 # 5468 <thread_join+0x3ba>
     ...
     974:	b3050513          	addi	a0,a0,-1232 # 54a0 <thread_join+0x3f2>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	b4450513          	addi	a0,a0,-1212 # 54c8 <thread_join+0x41a>
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	b5050513          	addi	a0,a0,-1200 # 54e8 <thread_join+0x43a>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	b5450513          	addi	a0,a0,-1196 # 5500 <thread_join+0x452>
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	b4a50513          	addi	a0,a0,-1206 # 5520 <thread_join+0x472>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	b0450513          	addi	a0,a0,-1276 # 5520 <thread_join+0x472>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	acc50513          	addi	a0,a0,-1332 # 5528 <thread_join+0x47a>
    ...
    exit(1);
     ...
     a76:	ad650513          	addi	a0,a0,-1322 # 5548 <thread_join+0x49a>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	aea50513          	addi	a0,a0,-1302 # 5570 <thread_join+0x4c2>
  ...
  if(unlink("big") < 0){
     ...
     aaa:	a7a50513          	addi	a0,a0,-1414 # 5520 <thread_join+0x472>
     ...
     ad0:	ac450513          	addi	a0,a0,-1340 # 5590 <thread_join+0x4e2>
     ...
     ae6:	ad650513          	addi	a0,a0,-1322 # 55b8 <thread_join+0x50a>
     ...
     afc:	ad850513          	addi	a0,a0,-1320 # 55d0 <thread_join+0x522>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	aec50513          	addi	a0,a0,-1300 # 55f8 <thread_join+0x54a>
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	ade50513          	addi	a0,a0,-1314 # 5610 <thread_join+0x562>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	afa58593          	addi	a1,a1,-1286 # 5640 <thread_join+0x592>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	ab650513          	addi	a0,a0,-1354 # 5610 <thread_join+0x562>
  ...
  unlink("unlinkread");
     ...
     be6:	a2e50513          	addi	a0,a0,-1490 # 5610 <thread_join+0x562>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	a2250513          	addi	a0,a0,-1502 # 5620 <thread_join+0x572>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	a3650513          	addi	a0,a0,-1482 # 5648 <thread_join+0x59a>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	a4250513          	addi	a0,a0,-1470 # 5668 <thread_join+0x5ba>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	a5650513          	addi	a0,a0,-1450 # 5690 <thread_join+0x5e2>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	a6250513          	addi	a0,a0,-1438 # 56b0 <thread_join+0x602>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	a6e50513          	addi	a0,a0,-1426 # 56d0 <thread_join+0x622>
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	a6e50513          	addi	a0,a0,-1426 # 56f0 <thread_join+0x642>
     c8a:	647030ef          	jal	4ad0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	a6a50513          	addi	a0,a0,-1430 # 56f8 <thread_join+0x64a>
     c96:	63b030ef          	jal	4ad0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	a5250513          	addi	a0,a0,-1454 # 56f0 <thread_join+0x642>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	98e58593          	addi	a1,a1,-1650 # 5640 <thread_join+0x592>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     d32:	9ca58593          	addi	a1,a1,-1590 # 56f8 <thread_join+0x64a>
     d36:	852e                	mv	a0,a1
     d38:	5a9030ef          	jal	4ae0 <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	9b850513          	addi	a0,a0,-1608 # 56f8 <thread_join+0x64a>
     d48:	589030ef          	jal	4ad0 <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	9a458593          	addi	a1,a1,-1628 # 56f0 <thread_join+0x642>
     d54:	00005517          	auipc	a0,0x5
     d58:	9a450513          	addi	a0,a0,-1628 # 56f8 <thread_join+0x64a>
     d5c:	585030ef          	jal	4ae0 <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	98c58593          	addi	a1,a1,-1652 # 56f0 <thread_join+0x642>
     d6c:	00005517          	auipc	a0,0x5
     d70:	a9450513          	addi	a0,a0,-1388 # 5800 <thread_join+0x752>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	97650513          	addi	a0,a0,-1674 # 5700 <thread_join+0x652>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	97a50513          	addi	a0,a0,-1670 # 5718 <thread_join+0x66a>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	97e50513          	addi	a0,a0,-1666 # 5730 <thread_join+0x682>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	98a50513          	addi	a0,a0,-1654 # 5750 <thread_join+0x6a2>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	9a650513          	addi	a0,a0,-1626 # 5780 <thread_join+0x6d2>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	9aa50513          	addi	a0,a0,-1622 # 5798 <thread_join+0x6ea>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	9ae50513          	addi	a0,a0,-1618 # 57b0 <thread_join+0x702>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	9c250513          	addi	a0,a0,-1598 # 57d8 <thread_join+0x72a>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	9de50513          	addi	a0,a0,-1570 # 5808 <thread_join+0x75a>
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	9d498993          	addi	s3,s3,-1580 # 5828 <thread_join+0x77a>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	9ac50513          	addi	a0,a0,-1620 # 5838 <thread_join+0x78a>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	9a450513          	addi	a0,a0,-1628 # 5858 <thread_join+0x7aa>
     ebc:	415030ef          	jal	4ad0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	99450513          	addi	a0,a0,-1644 # 5858 <thread_join+0x7aa>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	97aa0a13          	addi	s4,s4,-1670 # 5858 <thread_join+0x7aa>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	92c50513          	addi	a0,a0,-1748 # 5858 <thread_join+0x7aa>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	8cc50513          	addi	a0,a0,-1844 # 5860 <thread_join+0x7b2>
    ...
    exit(1);
     ...
     fb2:	8d250513          	addi	a0,a0,-1838 # 5880 <thread_join+0x7d2>
     ...
     fc6:	8e650513          	addi	a0,a0,-1818 # 58a8 <thread_join+0x7fa>
...
0000000000001000 <badarg>:
{
    ...
    101e:	0fe98993          	addi	s3,s3,254 # 5118 <thread_join+0x6a>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	96878793          	addi	a5,a5,-1688 # 69f8 <thread_join+0x194a>
  ...
  if(pid == 0){
    ...
    10e8:	3c478793          	addi	a5,a5,964 # 74a8 <thread_join+0x23fa>
    ...
    110c:	01050513          	addi	a0,a0,16 # 5118 <thread_join+0x6a>
    ...
    1120:	83450513          	addi	a0,a0,-1996 # 5950 <thread_join+0x8a2>
    ...
    1138:	79450513          	addi	a0,a0,1940 # 58c8 <thread_join+0x81a>
    ...
    1150:	79c50513          	addi	a0,a0,1948 # 58e8 <thread_join+0x83a>
    ...
    116a:	7a250513          	addi	a0,a0,1954 # 5908 <thread_join+0x85a>
    ...
    1182:	7b250513          	addi	a0,a0,1970 # 5930 <thread_join+0x882>
    ...
    1194:	d8850513          	addi	a0,a0,-632 # 6f18 <thread_join+0x1e6a>
  ...
  if(st != 747){
    ...
    11ce:	7ae50513          	addi	a0,a0,1966 # 5978 <thread_join+0x8ca>
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	f8450513          	addi	a0,a0,-124 # 5170 <thread_join+0xc2>
  ...
  if(pid == 0){
    ...
    1216:	f5ea0a13          	addi	s4,s4,-162 # 5170 <thread_join+0xc2>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	7bea8a93          	addi	s5,s5,1982 # 59d8 <thread_join+0x92a>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	73250513          	addi	a0,a0,1842 # 59a8 <thread_join+0x8fa>
    ...
    128e:	73650513          	addi	a0,a0,1846 # 59c0 <thread_join+0x912>
    ...
    12a4:	74850513          	addi	a0,a0,1864 # 59e8 <thread_join+0x93a>
    ...
    12c2:	eb2a0a13          	addi	s4,s4,-334 # 5170 <thread_join+0xc2>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	742a8a93          	addi	s5,s5,1858 # 5a08 <thread_join+0x95a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	e7050513          	addi	a0,a0,-400 # 5170 <thread_join+0xc2>
  ...
  exit(xstatus);
    ...
    131a:	6aa50513          	addi	a0,a0,1706 # 59c0 <thread_join+0x912>
    ...
    1330:	6e450513          	addi	a0,a0,1764 # 5a10 <thread_join+0x962>
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	dce78793          	addi	a5,a5,-562 # 5118 <thread_join+0x6a>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	6da78793          	addi	a5,a5,1754 # 5a30 <thread_join+0x982>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	6d250513          	addi	a0,a0,1746 # 5a38 <thread_join+0x98a>
  ...
  if(pid == 0) {
    ...
    138e:	6ae50513          	addi	a0,a0,1710 # 5a38 <thread_join+0x98a>
    ...
    13a6:	6b650513          	addi	a0,a0,1718 # 5a58 <thread_join+0x9aa>
    ...
    13bc:	5f050513          	addi	a0,a0,1520 # 59a8 <thread_join+0x8fa>
    ...
    13d0:	67450513          	addi	a0,a0,1652 # 5a40 <thread_join+0x992>
    ...
    13e6:	d3650513          	addi	a0,a0,-714 # 5118 <thread_join+0x6a>
  ...
  if(xstatus != 0)
    ...
    140e:	65e50513          	addi	a0,a0,1630 # 5a68 <thread_join+0x9ba>
    ...
    1422:	66250513          	addi	a0,a0,1634 # 5a80 <thread_join+0x9d2>
    1426:	283030ef          	jal	4ea8 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	60a50513          	addi	a0,a0,1546 # 5a38 <thread_join+0x98a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	09850513          	addi	a0,a0,152 # 54e8 <thread_join+0x43a>
    ...
    1468:	55c50513          	addi	a0,a0,1372 # 59c0 <thread_join+0x912>
  ...
  unlink("echo-ok");
    ...
    147a:	5c250513          	addi	a0,a0,1474 # 5a38 <thread_join+0x98a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	5fc50513          	addi	a0,a0,1532 # 5a98 <thread_join+0x9ea>
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	56850513          	addi	a0,a0,1384 # 5ab0 <thread_join+0xa02>
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	50650513          	addi	a0,a0,1286 # 5ac8 <thread_join+0xa1a>
    ...
    15da:	50a50513          	addi	a0,a0,1290 # 5ae0 <thread_join+0xa32>
    ...
    160a:	4f250513          	addi	a0,a0,1266 # 5af8 <thread_join+0xa4a>
    ...
    1642:	4da50513          	addi	a0,a0,1242 # 5b18 <thread_join+0xa6a>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	30850513          	addi	a0,a0,776 # 59a8 <thread_join+0x8fa>
    ...
    16b8:	47c50513          	addi	a0,a0,1148 # 5b30 <thread_join+0xa82>
    ...
    16cc:	48050513          	addi	a0,a0,1152 # 5b48 <thread_join+0xa9a>
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	28450513          	addi	a0,a0,644 # 59a8 <thread_join+0x8fa>
    ...
    1740:	26c50513          	addi	a0,a0,620 # 59a8 <thread_join+0x8fa>
...
0000000000001752 <forkfork>:
{
    ...
    179e:	3ce50513          	addi	a0,a0,974 # 5b68 <thread_join+0xaba>
    ...
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	3a250513          	addi	a0,a0,930 # 5b78 <thread_join+0xaca>
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	70850513          	addi	a0,a0,1800 # 6f18 <thread_join+0x1e6a>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	11650513          	addi	a0,a0,278 # 59a8 <thread_join+0x8fa>
    ...
    18ba:	18a50513          	addi	a0,a0,394 # 5a40 <thread_join+0x992>
    ...
    1918:	28450513          	addi	a0,a0,644 # 5b98 <thread_join+0xaea>
    ...
    193c:	27850513          	addi	a0,a0,632 # 5bb0 <thread_join+0xb02>
    ...
    198e:	24e50513          	addi	a0,a0,590 # 5bd8 <thread_join+0xb2a>
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	76450513          	addi	a0,a0,1892 # 5188 <thread_join+0xda>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	730b0b13          	addi	s6,s6,1840 # 5188 <thread_join+0xda>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	1a0c0c13          	addi	s8,s8,416 # 5c00 <thread_join+0xb52>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	f3c50513          	addi	a0,a0,-196 # 59a8 <thread_join+0x8fa>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	14450513          	addi	a0,a0,324 # 5c50 <thread_join+0xba2>
    ...
    1b28:	0e450513          	addi	a0,a0,228 # 5c08 <thread_join+0xb5a>
    ...
    1b3c:	0e850513          	addi	a0,a0,232 # 5c20 <thread_join+0xb72>
    ...
    1b50:	0ec50513          	addi	a0,a0,236 # 5c38 <thread_join+0xb8a>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	dbe50513          	addi	a0,a0,-578 # 59a8 <thread_join+0x8fa>
    ...
    1c08:	07450513          	addi	a0,a0,116 # 5c78 <thread_join+0xbca>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	d3650513          	addi	a0,a0,-714 # 59a8 <thread_join+0x8fa>
    ...
    1c9a:	00250513          	addi	a0,a0,2 # 5c98 <thread_join+0xbea>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	fca50513          	addi	a0,a0,-54 # 5cb0 <thread_join+0xc02>
    ...
    1cfe:	cae50513          	addi	a0,a0,-850 # 59a8 <thread_join+0x8fa>
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	78678793          	addi	a5,a5,1926 # 74a8 <thread_join+0x23fa>
  ...
  exit(0);
    ...
    1d8e:	f4e50513          	addi	a0,a0,-178 # 5cd8 <thread_join+0xc2a>
    ...
    1da2:	c0a50513          	addi	a0,a0,-1014 # 59a8 <thread_join+0x8fa>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	10e50513          	addi	a0,a0,270 # 6f18 <thread_join+0x1e6a>
    ...
    1ea0:	e5c50513          	addi	a0,a0,-420 # 5cf8 <thread_join+0xc4a>
    ...
    1eb8:	33450513          	addi	a0,a0,820 # 51e8 <thread_join+0x13a>
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	ad078793          	addi	a5,a5,-1328 # 69f8 <thread_join+0x194a>
  ...
  if(ret != -1){
    ...
    1f66:	dae50513          	addi	a0,a0,-594 # 5d10 <thread_join+0xc62>
    ...
    1f7c:	95050513          	addi	a0,a0,-1712 # 58c8 <thread_join+0x81a>
    ...
    1f92:	95a50513          	addi	a0,a0,-1702 # 58e8 <thread_join+0x83a>
    ...
    1faa:	96250513          	addi	a0,a0,-1694 # 5908 <thread_join+0x85a>
    ...
    1fc0:	97450513          	addi	a0,a0,-1676 # 5930 <thread_join+0x882>
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	d5850513          	addi	a0,a0,-680 # 5d50 <thread_join+0xca2>
  ...
  if(n >= 0){
    ...
    2024:	d5050513          	addi	a0,a0,-688 # 5d70 <thread_join+0xcc2>
    ...
    203a:	ce250513          	addi	a0,a0,-798 # 5d18 <thread_join+0xc6a>
    ...
    204e:	ce650513          	addi	a0,a0,-794 # 5d30 <thread_join+0xc82>
    ...
    2060:	cfc50513          	addi	a0,a0,-772 # 5d58 <thread_join+0xcaa>
  ...
  unlink("rwsbrk");
    ...
    2078:	cdc50513          	addi	a0,a0,-804 # 5d50 <thread_join+0xca2>
    207c:	255020ef          	jal	4ad0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	26e50513          	addi	a0,a0,622 # 52f0 <thread_join+0x242>
  ...
  if(n >= 0){
    ...
    20a8:	cfc50513          	addi	a0,a0,-772 # 5da0 <thread_join+0xcf2>
    ...
    20ba:	ca250513          	addi	a0,a0,-862 # 5d58 <thread_join+0xcaa>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	ca850513          	addi	a0,a0,-856 # 5dc8 <thread_join+0xd1a>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	c7850513          	addi	a0,a0,-904 # 5de8 <thread_join+0xd3a>
  ...
  if(c != a + 1){
    ...
    21c0:	c8c50513          	addi	a0,a0,-884 # 5e48 <thread_join+0xd9a>
    ...
    21da:	c3250513          	addi	a0,a0,-974 # 5e08 <thread_join+0xd5a>
    ...
    21ee:	c3e50513          	addi	a0,a0,-962 # 5e28 <thread_join+0xd7a>
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22f0:	b7c50513          	addi	a0,a0,-1156 # 5e68 <thread_join+0xdba>
    ...
    2304:	bb050513          	addi	a0,a0,-1104 # 5eb0 <thread_join+0xe02>
    ...
    231c:	bb850513          	addi	a0,a0,-1096 # 5ed0 <thread_join+0xe22>
    ...
    2334:	be050513          	addi	a0,a0,-1056 # 5f10 <thread_join+0xe62>
    ...
    2348:	bfc50513          	addi	a0,a0,-1028 # 5f40 <thread_join+0xe92>
    ...
    2360:	c1c50513          	addi	a0,a0,-996 # 5f78 <thread_join+0xeca>
...
000000000000236e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    238e:	c1650513          	addi	a0,a0,-1002 # 5fa0 <thread_join+0xef2>
    2392:	72e020ef          	jal	4ac0 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	c0850513          	addi	a0,a0,-1016 # 5fa0 <thread_join+0xef2>
  ...
  if(pipe((int *) a) != 0){
    ...
    23dc:	bd050513          	addi	a0,a0,-1072 # 5fa8 <thread_join+0xefa>
    ...
    23f0:	bd450513          	addi	a0,a0,-1068 # 5fc0 <thread_join+0xf12>
    ...
    2404:	6b050513          	addi	a0,a0,1712 # 5ab0 <thread_join+0xa02>
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	bb650513          	addi	a0,a0,-1098 # 5fd8 <thread_join+0xf2a>
  ...
  close(fd);
    ...
    245e:	56650513          	addi	a0,a0,1382 # 59c0 <thread_join+0x912>
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2494:	a8850513          	addi	a0,a0,-1400 # 6f18 <thread_join+0x1e6a>
  ...
  if(pid == 0){
    ...
    24ce:	a4e50513          	addi	a0,a0,-1458 # 6f18 <thread_join+0x1e6a>
  ...
  if(pid == 0){
    ...
    250e:	a0e50513          	addi	a0,a0,-1522 # 6f18 <thread_join+0x1e6a>
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	8ee50513          	addi	a0,a0,-1810 # 6f18 <thread_join+0x1e6a>
    ...
    266e:	aae50513          	addi	a0,a0,-1362 # 5118 <thread_join+0x6a>
    2672:	faa43c23          	sd	a0,-72(s0)
    2676:	00003797          	auipc	a5,0x3
    267a:	b1278793          	addi	a5,a5,-1262 # 5188 <thread_join+0xda>
...
0000000000002694 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26a4:	b1050513          	addi	a0,a0,-1264 # 61b0 <thread_join+0x1102>
    26a8:	440020ef          	jal	4ae8 <mkdir>
    26ac:	e555                	bnez	a0,2758 <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    26ae:	00004517          	auipc	a0,0x4
    26b2:	95a50513          	addi	a0,a0,-1702 # 6008 <thread_join+0xf5a>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c4:	9a050513          	addi	a0,a0,-1632 # 6060 <thread_join+0xfb2>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26da:	a0250513          	addi	a0,a0,-1534 # 60d8 <thread_join+0x102a>
  ...
  unlink("12345678901234");
    ...
    275e:	88650513          	addi	a0,a0,-1914 # 5fe0 <thread_join+0xf32>
    ...
    2772:	8ba50513          	addi	a0,a0,-1862 # 6028 <thread_join+0xf7a>
    ...
    2786:	90e50513          	addi	a0,a0,-1778 # 6090 <thread_join+0xfe2>
    ...
    279a:	97250513          	addi	a0,a0,-1678 # 6108 <thread_join+0x105a>
    ...
    27ae:	9be50513          	addi	a0,a0,-1602 # 6168 <thread_join+0x10ba>
    ...
    27c2:	a0250513          	addi	a0,a0,-1534 # 61c0 <thread_join+0x1112>
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	9f250513          	addi	a0,a0,-1550 # 61f8 <thread_join+0x114a>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	9d650513          	addi	a0,a0,-1578 # 6208 <thread_join+0x115a>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    28ac:	95050513          	addi	a0,a0,-1712 # 61f8 <thread_join+0x114a>
    28b0:	238020ef          	jal	4ae8 <mkdir>
    28b4:	12050063          	beqz	a0,29d4 <diskfull+0x204>
  unlink("diskfulldir");
    28b8:	00004517          	auipc	a0,0x4
    28bc:	94050513          	addi	a0,a0,-1728 # 61f8 <thread_join+0x114a>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29da:	85250513          	addi	a0,a0,-1966 # 6228 <thread_join+0x117a>
...
00000000000029e4 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a40:	82450513          	addi	a0,a0,-2012 # 6260 <thread_join+0x11b2>
    ...
    2a54:	82850513          	addi	a0,a0,-2008 # 6278 <thread_join+0x11ca>
    ...
    2a68:	84450513          	addi	a0,a0,-1980 # 62a8 <thread_join+0x11fa>
    ...
    2a7c:	85850513          	addi	a0,a0,-1960 # 62d0 <thread_join+0x1222>
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2adc:	ed050513          	addi	a0,a0,-304 # 59a8 <thread_join+0x8fa>
    ...
    2af0:	77450513          	addi	a0,a0,1908 # 6260 <thread_join+0x11b2>
    ...
    2b04:	7e850513          	addi	a0,a0,2024 # 62e8 <thread_join+0x123a>
    ...
    2b18:	79450513          	addi	a0,a0,1940 # 62a8 <thread_join+0x11fa>
...
0000000000002b36 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b92:	6d250513          	addi	a0,a0,1746 # 6260 <thread_join+0x11b2>
    ...
    2ba6:	76650513          	addi	a0,a0,1894 # 6308 <thread_join+0x125a>
    ...
    2bba:	77250513          	addi	a0,a0,1906 # 6328 <thread_join+0x127a>
    ...
    2bce:	77650513          	addi	a0,a0,1910 # 6340 <thread_join+0x1292>
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	89e50513          	addi	a0,a0,-1890 # 6488 <thread_join+0x13da>
    2bf2:	6df010ef          	jal	4ad0 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	76250513          	addi	a0,a0,1890 # 6358 <thread_join+0x12aa>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2c0e:	76e50513          	addi	a0,a0,1902 # 6378 <thread_join+0x12ca>
  ...
  write(fd, "ff", 2);
    ...
    2c22:	86a58593          	addi	a1,a1,-1942 # 6488 <thread_join+0x13da>
  ...
  if(unlink("dd") >= 0){
    ...
    2c34:	72850513          	addi	a0,a0,1832 # 6358 <thread_join+0x12aa>
    2c38:	699010ef          	jal	4ad0 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	79050513          	addi	a0,a0,1936 # 63d0 <thread_join+0x1322>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c58:	7a450513          	addi	a0,a0,1956 # 63f8 <thread_join+0x134a>
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	7c058593          	addi	a1,a1,1984 # 6428 <thread_join+0x137a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c80:	7b450513          	addi	a0,a0,1972 # 6430 <thread_join+0x1382>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d66:	69650513          	addi	a0,a0,1686 # 63f8 <thread_join+0x134a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d7a:	89a50513          	addi	a0,a0,-1894 # 6610 <thread_join+0x1562>
  ...
  if(unlink("dd") < 0){
    ...
    2eec:	47850513          	addi	a0,a0,1144 # 6360 <thread_join+0x12b2>
    ...
    2f00:	48450513          	addi	a0,a0,1156 # 6380 <thread_join+0x12d2>
    ...
    2f14:	49050513          	addi	a0,a0,1168 # 63a0 <thread_join+0x12f2>
    ...
    2f28:	4b450513          	addi	a0,a0,1204 # 63d8 <thread_join+0x132a>
    ...
    2f3c:	4d050513          	addi	a0,a0,1232 # 6408 <thread_join+0x135a>
    ...
    2f50:	4f450513          	addi	a0,a0,1268 # 6440 <thread_join+0x1392>
    ...
    2f64:	50050513          	addi	a0,a0,1280 # 6460 <thread_join+0x13b2>
    ...
    2f78:	51c50513          	addi	a0,a0,1308 # 6490 <thread_join+0x13e2>
    ...
    2f8c:	53050513          	addi	a0,a0,1328 # 64b8 <thread_join+0x140a>
    ...
    2fa0:	53c50513          	addi	a0,a0,1340 # 64d8 <thread_join+0x142a>
    ...
    2fb4:	55050513          	addi	a0,a0,1360 # 6500 <thread_join+0x1452>
    ...
    2fc8:	56450513          	addi	a0,a0,1380 # 6528 <thread_join+0x147a>
    ...
    2fdc:	58050513          	addi	a0,a0,1408 # 6558 <thread_join+0x14aa>
    ...
    2ff0:	59c50513          	addi	a0,a0,1436 # 6588 <thread_join+0x14da>
    ...
    3004:	5a050513          	addi	a0,a0,1440 # 65a0 <thread_join+0x14f2>
    ...
    3018:	5ac50513          	addi	a0,a0,1452 # 65c0 <thread_join+0x1512>
    ...
    302c:	5b850513          	addi	a0,a0,1464 # 65e0 <thread_join+0x1532>
    ...
    3040:	5e450513          	addi	a0,a0,1508 # 6620 <thread_join+0x1572>
    ...
    3054:	60050513          	addi	a0,a0,1536 # 6650 <thread_join+0x15a2>
    ...
    3068:	60c50513          	addi	a0,a0,1548 # 6670 <thread_join+0x15c2>
    ...
    307c:	61850513          	addi	a0,a0,1560 # 6690 <thread_join+0x15e2>
    ...
    3090:	62450513          	addi	a0,a0,1572 # 66b0 <thread_join+0x1602>
    ...
    30a4:	64050513          	addi	a0,a0,1600 # 66e0 <thread_join+0x1632>
    ...
    30b8:	65450513          	addi	a0,a0,1620 # 6708 <thread_join+0x165a>
    ...
    30cc:	66850513          	addi	a0,a0,1640 # 6730 <thread_join+0x1682>
    ...
    30e0:	67c50513          	addi	a0,a0,1660 # 6758 <thread_join+0x16aa>
    ...
    30f4:	68850513          	addi	a0,a0,1672 # 6778 <thread_join+0x16ca>
    ...
    3108:	69450513          	addi	a0,a0,1684 # 6798 <thread_join+0x16ea>
    ...
    311c:	6a850513          	addi	a0,a0,1704 # 67c0 <thread_join+0x1712>
    ...
    3130:	6b450513          	addi	a0,a0,1716 # 67e0 <thread_join+0x1732>
    ...
    3144:	6c050513          	addi	a0,a0,1728 # 6800 <thread_join+0x1752>
    ...
    3158:	6d450513          	addi	a0,a0,1748 # 6828 <thread_join+0x177a>
    ...
    316c:	35050513          	addi	a0,a0,848 # 64b8 <thread_join+0x140a>
    ...
    3180:	6cc50513          	addi	a0,a0,1740 # 6848 <thread_join+0x179a>
    ...
    3194:	6d850513          	addi	a0,a0,1752 # 6868 <thread_join+0x17ba>
    ...
    31a8:	6f450513          	addi	a0,a0,1780 # 6898 <thread_join+0x17ea>
    ...
    31bc:	70050513          	addi	a0,a0,1792 # 68b8 <thread_join+0x180a>
...
00000000000031ca <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3256:	68650513          	addi	a0,a0,1670 # 68d8 <thread_join+0x182a>
    ...
    326a:	68a50513          	addi	a0,a0,1674 # 68f0 <thread_join+0x1842>
    ...
    327e:	68e50513          	addi	a0,a0,1678 # 6908 <thread_join+0x185a>
    ...
    3292:	69250513          	addi	a0,a0,1682 # 6920 <thread_join+0x1872>
    ...
    32a6:	02e50513          	addi	a0,a0,46 # 62d0 <thread_join+0x1222>
    ...
    32ba:	68a50513          	addi	a0,a0,1674 # 6940 <thread_join+0x1892>
    ...
    32ce:	69e50513          	addi	a0,a0,1694 # 6968 <thread_join+0x18ba>
    ...
    32e2:	6aa50513          	addi	a0,a0,1706 # 6988 <thread_join+0x18da>
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	6a650513          	addi	a0,a0,1702 # 69a8 <thread_join+0x18fa>
  ...
  if(chdir("dirfile") == 0){
    ...
    331a:	69250513          	addi	a0,a0,1682 # 69a8 <thread_join+0x18fa>
    331e:	7d2010ef          	jal	4af0 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	6ca50513          	addi	a0,a0,1738 # 69f0 <thread_join+0x1942>
  ...
  fd = open(".", 0);
    ...
    33aa:	45a50513          	addi	a0,a0,1114 # 5800 <thread_join+0x752>
    33ae:	712010ef          	jal	4ac0 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	dd258593          	addi	a1,a1,-558 # 5188 <thread_join+0xda>
  ...
  close(fd);
    ...
    33de:	5d650513          	addi	a0,a0,1494 # 69b0 <thread_join+0x1902>
    ...
    33f2:	5e250513          	addi	a0,a0,1506 # 69d0 <thread_join+0x1922>
    ...
    3406:	5fe50513          	addi	a0,a0,1534 # 6a00 <thread_join+0x1952>
    ...
    341a:	5ea50513          	addi	a0,a0,1514 # 6a00 <thread_join+0x1952>
    ...
    342e:	5fe50513          	addi	a0,a0,1534 # 6a28 <thread_join+0x197a>
    ...
    3442:	61250513          	addi	a0,a0,1554 # 6a50 <thread_join+0x19a2>
    ...
    3456:	62650513          	addi	a0,a0,1574 # 6a78 <thread_join+0x19ca>
    ...
    346a:	63a50513          	addi	a0,a0,1594 # 6aa0 <thread_join+0x19f2>
    ...
    347e:	64650513          	addi	a0,a0,1606 # 6ac0 <thread_join+0x1a12>
    ...
    3492:	65a50513          	addi	a0,a0,1626 # 6ae8 <thread_join+0x1a3a>
...
00000000000034a0 <iref>:
{
    ...
    34be:	646a0a13          	addi	s4,s4,1606 # 6b00 <thread_join+0x1a52>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	14648493          	addi	s1,s1,326 # 6608 <thread_join+0x155a>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	e26a8a93          	addi	s5,s5,-474 # 52f0 <thread_join+0x242>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	52698993          	addi	s3,s3,1318 # 69f8 <thread_join+0x194a>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	62a50513          	addi	a0,a0,1578 # 6b08 <thread_join+0x1a5a>
    ...
    34f6:	62e50513          	addi	a0,a0,1582 # 6b20 <thread_join+0x1a72>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    355e:	dc698993          	addi	s3,s3,-570 # 6320 <thread_join+0x1272>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	59e90913          	addi	s2,s2,1438 # 6b00 <thread_join+0x1a52>
    chdir("..");
    356a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    357e:	d4e50513          	addi	a0,a0,-690 # 62c8 <thread_join+0x121a>
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	59250513          	addi	a0,a0,1426 # 6b38 <thread_join+0x1a8a>
  ...
  if(pid == 0){
    ...
    35c6:	57650513          	addi	a0,a0,1398 # 6b38 <thread_join+0x1a8a>
    ...
    35d8:	58450513          	addi	a0,a0,1412 # 6b58 <thread_join+0x1aaa>
    ...
    35ec:	55850513          	addi	a0,a0,1368 # 6b40 <thread_join+0x1a92>
    ...
    3600:	3ac50513          	addi	a0,a0,940 # 59a8 <thread_join+0x8fa>
  ...
  if(unlink("oidir") != 0){
    ...
    361e:	51e50513          	addi	a0,a0,1310 # 6b38 <thread_join+0x1a8a>
    3622:	4ae010ef          	jal	4ad0 <unlink>
    3626:	c919                	beqz	a0,363c <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3628:	85a6                	mv	a1,s1
    362a:	00002517          	auipc	a0,0x2
    362e:	56e50513          	addi	a0,a0,1390 # 5b98 <thread_join+0xaea>
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	52850513          	addi	a0,a0,1320 # 6b80 <thread_join+0x1ad2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    367c:	50850513          	addi	a0,a0,1288 # 6b80 <thread_join+0x1ad2>
  ...
  sleep(10); // one second
    ...
    36a4:	4c850513          	addi	a0,a0,1224 # 5b68 <thread_join+0xaba>
    ...
    36b6:	4ce48493          	addi	s1,s1,1230 # 6b80 <thread_join+0x1ad2>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    ...
    36d6:	4ae50513          	addi	a0,a0,1198 # 6b80 <thread_join+0x1ad2>
...
00000000000036ea <killstatus>:
{
  ...
  exit(0);
    ...
    373c:	27050513          	addi	a0,a0,624 # 59a8 <thread_join+0x8fa>
    ...
    3756:	43e50513          	addi	a0,a0,1086 # 6b90 <thread_join+0x1ae2>
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	3e250513          	addi	a0,a0,994 # 5b68 <thread_join+0xaba>
  ...
  if(pid2 == 0)
    ...
    37ac:	20050513          	addi	a0,a0,512 # 59a8 <thread_join+0x8fa>
  ...
  if(pid3 == 0){
    ...
    37dc:	9b058593          	addi	a1,a1,-1616 # 5188 <thread_join+0xda>
    ...
    37fe:	1ae50513          	addi	a0,a0,430 # 59a8 <thread_join+0x8fa>
    ...
    3812:	3a250513          	addi	a0,a0,930 # 6bb0 <thread_join+0x1b02>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	38a50513          	addi	a0,a0,906 # 6bc8 <thread_join+0x1b1a>
  ...
  printf("kill... ");
    ...
    3866:	37e50513          	addi	a0,a0,894 # 6be0 <thread_join+0x1b32>
  ...
  printf("wait... ");
    ...
    3884:	37050513          	addi	a0,a0,880 # 6bf0 <thread_join+0x1b42>
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	0c850513          	addi	a0,a0,200 # 59a8 <thread_join+0x8fa>
    ...
    38f8:	23c50513          	addi	a0,a0,572 # 5b30 <thread_join+0xa82>
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	16250513          	addi	a0,a0,354 # 5ab0 <thread_join+0xa02>
    ...
    3976:	81658593          	addi	a1,a1,-2026 # 5188 <thread_join+0xda>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	1ee50513          	addi	a0,a0,494 # 6c00 <thread_join+0x1b52>
    ...
    3a2a:	f8250513          	addi	a0,a0,-126 # 59a8 <thread_join+0x8fa>
    ...
    3a66:	1be50513          	addi	a0,a0,446 # 6c20 <thread_join+0x1b72>
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ade:	17650513          	addi	a0,a0,374 # 6c50 <thread_join+0x1ba2>
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	17250513          	addi	a0,a0,370 # 6c70 <thread_join+0x1bc2>
    3b06:	7cb000ef          	jal	4ad0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	16250513          	addi	a0,a0,354 # 6c70 <thread_join+0x1bc2>
  ...
  if(pid == 0) {
    ...
    3b7c:	10850513          	addi	a0,a0,264 # 6c80 <thread_join+0x1bd2>
    ...
    3b90:	11c50513          	addi	a0,a0,284 # 6ca8 <thread_join+0x1bfa>
  ...
  fd = open("sharedfd", 0);
    ...
    3bc0:	0b450513          	addi	a0,a0,180 # 6c70 <thread_join+0x1bc2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	0d450513          	addi	a0,a0,212 # 6cc8 <thread_join+0x1c1a>
  ...
  unlink("sharedfd");
    ...
    3c28:	04c50513          	addi	a0,a0,76 # 6c70 <thread_join+0x1bc2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	0aa50513          	addi	a0,a0,170 # 6cf0 <thread_join+0x1c42>
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	08a78793          	addi	a5,a5,138 # 6d08 <thread_join+0x1c5a>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	08678793          	addi	a5,a5,134 # 6d10 <thread_join+0x1c62>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	08278793          	addi	a5,a5,130 # 6d18 <thread_join+0x1c6a>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	07e78793          	addi	a5,a5,126 # 6d20 <thread_join+0x1c72>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	ca450513          	addi	a0,a0,-860 # 59a8 <thread_join+0x8fa>
    ...
    3d6a:	cda50513          	addi	a0,a0,-806 # 5a40 <thread_join+0x992>
    ...
    3d7c:	fb050513          	addi	a0,a0,-80 # 6d28 <thread_join+0x1c7a>
    ...
    3d96:	fae50513          	addi	a0,a0,-82 # 6d40 <thread_join+0x1c92>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	f4e50513          	addi	a0,a0,-178 # 6d50 <thread_join+0x1ca2>
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	f0cb8b93          	addi	s7,s7,-244 # 6d68 <thread_join+0x1cba>
  for(i = 0; i < N; i++){
    ...
    3e9a:	eda50513          	addi	a0,a0,-294 # 6d70 <thread_join+0x1cc2>
    ...
    3eb0:	ebc50513          	addi	a0,a0,-324 # 6d68 <thread_join+0x1cba>
  ...
  fd = open(".", 0);
    ...
    3ed8:	92c50513          	addi	a0,a0,-1748 # 5800 <thread_join+0x752>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	e4c50513          	addi	a0,a0,-436 # 6d90 <thread_join+0x1ce2>
    ...
    3f60:	e5450513          	addi	a0,a0,-428 # 6db0 <thread_join+0x1d02>
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	e5050513          	addi	a0,a0,-432 # 6dd8 <thread_join+0x1d2a>
    ...
    3fa0:	a0c50513          	addi	a0,a0,-1524 # 59a8 <thread_join+0x8fa>
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	d2650513          	addi	a0,a0,-730 # 6e10 <thread_join+0x1d62>
    40f2:	1df000ef          	jal	4ad0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	d1650513          	addi	a0,a0,-746 # 6e10 <thread_join+0x1d62>
  ...
  fd = open("bigfile.dat", 0);
    ...
    414a:	cca50513          	addi	a0,a0,-822 # 6e10 <thread_join+0x1d62>
  ...
  for(i = 0; ; i++){
    ...
    41a6:	c7e50513          	addi	a0,a0,-898 # 6e20 <thread_join+0x1d72>
    ...
    41ba:	c8a50513          	addi	a0,a0,-886 # 6e40 <thread_join+0x1d92>
    ...
    41ce:	c9650513          	addi	a0,a0,-874 # 6e60 <thread_join+0x1db2>
    ...
    41e2:	ca250513          	addi	a0,a0,-862 # 6e80 <thread_join+0x1dd2>
    ...
    41f6:	cae50513          	addi	a0,a0,-850 # 6ea0 <thread_join+0x1df2>
    ...
    420a:	cb250513          	addi	a0,a0,-846 # 6eb8 <thread_join+0x1e0a>
  ...
  unlink("bigfile.dat");
    ...
    422c:	be850513          	addi	a0,a0,-1048 # 6e10 <thread_join+0x1d62>
    ...
    424c:	c9050513          	addi	a0,a0,-880 # 6ed8 <thread_join+0x1e2a>
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c9250513          	addi	a0,a0,-878 # 6ef8 <thread_join+0x1e4a>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	c6c50513          	addi	a0,a0,-916 # 6ef8 <thread_join+0x1e4a>
  ...
  close(fd);
    ...
    42ea:	e3250513          	addi	a0,a0,-462 # 5118 <thread_join+0x6a>
    42ee:	7ca000ef          	jal	4ab8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	c0250513          	addi	a0,a0,-1022 # 6ef8 <thread_join+0x1e4a>
    ...
    4312:	bfa50513          	addi	a0,a0,-1030 # 6f08 <thread_join+0x1e5a>
    ...
    432a:	c0250513          	addi	a0,a0,-1022 # 6f28 <thread_join+0x1e7a>
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	bf450513          	addi	a0,a0,-1036 # 6f48 <thread_join+0x1e9a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4374:	be8c8c93          	addi	s9,s9,-1048 # 6f58 <thread_join+0x1eaa>
    name[0] = 'f';
    ...
    43dc:	b9050513          	addi	a0,a0,-1136 # 6f68 <thread_join+0x1eba>
  ...
  printf("fsfull test finished\n");
    ...
    444a:	b4250513          	addi	a0,a0,-1214 # 6f88 <thread_join+0x1eda>
    ...
    4498:	ae450513          	addi	a0,a0,-1308 # 6f78 <thread_join+0x1eca>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	ae250513          	addi	a0,a0,-1310 # 6fa0 <thread_join+0x1ef2>
  ...
  if(pid == 0) {
    ...
    44e6:	ae650513          	addi	a0,a0,-1306 # 6fc8 <thread_join+0x1f1a>
    ...
    4506:	aae50513          	addi	a0,a0,-1362 # 6fb0 <thread_join+0x1f02>
    ...
    4522:	ab250513          	addi	a0,a0,-1358 # 6fd0 <thread_join+0x1f22>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	a6250513          	addi	a0,a0,-1438 # 6fd8 <thread_join+0x1f2a>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	bb298993          	addi	s3,s3,-1102 # 5188 <thread_join+0xda>
      uint64 a = (uint64) sbrk(4096);
    ...
    4604:	a3050513          	addi	a0,a0,-1488 # 7030 <thread_join+0x1f82>
    ...
    461c:	9d850513          	addi	a0,a0,-1576 # 6ff0 <thread_join+0x1f42>
    ...
    4634:	9e050513          	addi	a0,a0,-1568 # 7010 <thread_join+0x1f62>
  ...
  while(1){
    ...
    4674:	9e050513          	addi	a0,a0,-1568 # 7050 <thread_join+0x1fa2>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	9b2b8b93          	addi	s7,s7,-1614 # 7070 <thread_join+0x1fc2>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	9b0d0d13          	addi	s10,s10,-1616 # 7088 <thread_join+0x1fda>
          return 1;
        }
      }
    }
    ...
    46e4:	9c8c8c93          	addi	s9,s9,-1592 # 70a8 <thread_join+0x1ffa>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	93c58593          	addi	a1,a1,-1732 # 70d8 <thread_join+0x202a>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	93258593          	addi	a1,a1,-1742 # 70e0 <thread_join+0x2032>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	92a58593          	addi	a1,a1,-1750 # 70e8 <thread_join+0x203a>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	91050513          	addi	a0,a0,-1776 # 70f0 <thread_join+0x2042>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	91c50513          	addi	a0,a0,-1764 # 7120 <thread_join+0x2072>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4b70:	9b450513          	addi	a0,a0,-1612 # 7520 <digits>
    4b74:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    4e06:	71eb8b93          	addi	s7,s7,1822 # 7520 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    4e54:	62090913          	addi	s2,s2,1568 # 7470 <thread_join+0x23c2>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
    ...
    505a:	ec26                	sd	s1,24(sp)
    505c:	e84a                	sd	s2,16(sp)
    505e:	e44e                	sd	s3,8(sp)
  ...
  if (stack == 0) {
    506e:	c105                	beqz	a0,508e <thread_create+0x3a>
    5070:	86aa                	mv	a3,a0
  ...
  int tid = clone(start_routine, arg1, arg2, stack);
    ...
    5074:	85ca                	mv	a1,s2
    5076:	8526                	mv	a0,s1
    5078:	aa9ff0ef          	jal	4b20 <clone>

  if (tid < 0) {
    507c:	02054163          	bltz	a0,509e <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
  ...
  return tid;
    ...
    5080:	70a2                	ld	ra,40(sp)
    5082:	7402                	ld	s0,32(sp)
    5084:	64e2                	ld	s1,24(sp)
    5086:	6942                	ld	s2,16(sp)
    5088:	69a2                	ld	s3,8(sp)
    508a:	6145                	addi	sp,sp,48
    508c:	8082                	ret
    printf("stack allocation failed\n");
    508e:	00002517          	auipc	a0,0x2
    5092:	3ea50513          	addi	a0,a0,1002 # 7478 <thread_join+0x23ca>
    5096:	e13ff0ef          	jal	4ea8 <printf>
    return -1;
    509a:	557d                	li	a0,-1
    509c:	b7d5                	j	5080 <thread_create+0x2c>
    printf("clone failed\n");
    509e:	00002517          	auipc	a0,0x2
    50a2:	3fa50513          	addi	a0,a0,1018 # 7498 <thread_join+0x23ea>
    50a6:	e03ff0ef          	jal	4ea8 <printf>
    return -1;
    50aa:	557d                	li	a0,-1
    50ac:	bfd1                	j	5080 <thread_create+0x2c>

00000000000050ae <thread_join>:
...
int thread_join(){
    ...
    50b6:	1800                	addi	s0,sp,48
  //printf("thread join executed\n");
  void *stack;

  int pid = join(&stack);
    50b8:	fd840513          	addi	a0,s0,-40
    50bc:	a6dff0ef          	jal	4b28 <join>

  if (pid < 0)
    50c0:	00054d63          	bltz	a0,50da <thread_join+0x2c>
    50c4:	84aa                	mv	s1,a0
    return -1;

  free(stack);
    50c6:	fd843503          	ld	a0,-40(s0)
    50ca:	e11ff0ef          	jal	4eda <free>

  return pid;
    50ce:	8526                	mv	a0,s1
    50d0:	70a2                	ld	ra,40(sp)
    50d2:	7402                	ld	s0,32(sp)
    50d4:	64e2                	ld	s1,24(sp)
    50d6:	6145                	addi	sp,sp,48
    50d8:	8082                	ret
    return -1;
    50da:	54fd                	li	s1,-1
    50dc:	bfcd                	j	50ce <thread_join+0x20>
