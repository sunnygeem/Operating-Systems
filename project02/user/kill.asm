...
main(int argc, char **argv)
{
  ...
  44:	8e058593          	addi	a1,a1,-1824 # 920 <thread_join+0x34>
  48:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ae:	5c650513          	addi	a0,a0,1478 # 970 <digits>
 3b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 692:	2aa90913          	addi	s2,s2,682 # 938 <thread_join+0x4c>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 8a8:	ef3ff0ef          	jal	79a <malloc>
  ...
  if (stack == 0) {
 8ac:	c105                	beqz	a0,8cc <thread_create+0x3a>
 8ae:	86aa                	mv	a3,a0
 ...
 8b2:	85ca                	mv	a1,s2
 8b4:	8526                	mv	a0,s1
 8b6:	aa9ff0ef          	jal	35e <clone>

  if (tid < 0) {
 8ba:	02054163          	bltz	a0,8dc <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 8d0:	07450513          	addi	a0,a0,116 # 940 <thread_join+0x54>
 8d4:	e13ff0ef          	jal	6e6 <printf>
    return -1;
 8d8:	557d                	li	a0,-1
 8da:	b7d5                	j	8be <thread_create+0x2c>
    printf("clone failed\n");
 8dc:	00000517          	auipc	a0,0x0
 8e0:	08450513          	addi	a0,a0,132 # 960 <thread_join+0x74>
 8e4:	e03ff0ef          	jal	6e6 <printf>
    return -1;
 8e8:	557d                	li	a0,-1
 8ea:	bfd1                	j	8be <thread_create+0x2c>

00000000000008ec <thread_join>:

int thread_join(){
 8ec:	7179                	addi	sp,sp,-48
 8ee:	f406                	sd	ra,40(sp)
 8f0:	f022                	sd	s0,32(sp)
 8f2:	ec26                	sd	s1,24(sp)
 8f4:	1800                	addi	s0,sp,48
  //printf("thread join executed\n");
  void *stack;

  int pid = join(&stack);
 8f6:	fd840513          	addi	a0,s0,-40
 8fa:	a6dff0ef          	jal	366 <join>

  if (pid < 0)
 8fe:	00054d63          	bltz	a0,918 <thread_join+0x2c>
 902:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 904:	fd843503          	ld	a0,-40(s0)
 908:	e11ff0ef          	jal	718 <free>
 ...
 916:	8082                	ret
    return -1;
 918:	54fd                	li	s1,-1
 91a:	bfcd                	j	90c <thread_join+0x20>
