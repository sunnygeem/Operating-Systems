...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	12650513          	addi	a0,a0,294 # 11b0 <thread_join+0x34>
      92:	325000ef          	jal	bb6 <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	11a50513          	addi	a0,a0,282 # 11b0 <thread_join+0x34>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b2:	10a50513          	addi	a0,a0,266 # 11b8 <thread_join+0x3c>
  ...
  chdir("/");
      ...
      ce:	11650513          	addi	a0,a0,278 # 11e0 <thread_join+0x64>
      d2:	2ed000ef          	jal	bbe <chdir>
      d6:	00001997          	auipc	s3,0x1
      da:	11a98993          	addi	s3,s3,282 # 11f0 <thread_join+0x74>
      de:	c489                	beqz	s1,e8 <go+0x74>
      e0:	00001997          	auipc	s3,0x1
      e4:	10898993          	addi	s3,s3,264 # 11e8 <thread_join+0x6c>
  uint64 iters = 0;
      e8:	4481                	li	s1,0
  int fd = -1;
      ea:	5a7d                	li	s4,-1
      ec:	00001917          	auipc	s2,0x1
      f0:	40490913          	addi	s2,s2,1028 # 14f0 <thread_join+0x374>
    ...
    if(what == 1){
      ...
      fe:	0fe50513          	addi	a0,a0,254 # 11f8 <thread_join+0x7c>
    ...
    int what = rand() % 23;
     ...
     14c:	0c050513          	addi	a0,a0,192 # 1208 <thread_join+0x8c>
     ...
     15e:	09e50513          	addi	a0,a0,158 # 11f8 <thread_join+0x7c>
     162:	23d000ef          	jal	b9e <unlink>
     166:	b755                	j	10a <go+0x96>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     168:	00001517          	auipc	a0,0x1
     16c:	04850513          	addi	a0,a0,72 # 11b0 <thread_join+0x34>
     ...
     17a:	0aa50513          	addi	a0,a0,170 # 1220 <thread_join+0xa4>
     17e:	221000ef          	jal	b9e <unlink>
      chdir("/");
     182:	00001517          	auipc	a0,0x1
     186:	05e50513          	addi	a0,a0,94 # 11e0 <thread_join+0x64>
     18a:	235000ef          	jal	bbe <chdir>
     18e:	bfb5                	j	10a <go+0x96>
        printf("grind: chdir grindir failed\n");
     190:	00001517          	auipc	a0,0x1
     194:	02850513          	addi	a0,a0,40 # 11b8 <thread_join+0x3c>
     ...
     1b0:	07c50513          	addi	a0,a0,124 # 1228 <thread_join+0xac>
     ...
     1ca:	07250513          	addi	a0,a0,114 # 1238 <thread_join+0xbc>
     ...
     2b8:	00c50513          	addi	a0,a0,12 # 12c0 <thread_join+0x144>
     ...
     2ea:	fda50513          	addi	a0,a0,-38 # 12c0 <thread_join+0x144>
     ...
     2f4:	05b000ef          	jal	b4e <exit>
      ...
      sbrk(6011);
     2f8:	6505                	lui	a0,0x1
     2fa:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x22b>
     ...
     32e:	fb650513          	addi	a0,a0,-74 # 12e0 <thread_join+0x164>
     ...
     34e:	f8e50513          	addi	a0,a0,-114 # 12d8 <thread_join+0x15c>
     ...
     364:	f6050513          	addi	a0,a0,-160 # 12c0 <thread_join+0x144>
     ...
     376:	f7e50513          	addi	a0,a0,-130 # 12f0 <thread_join+0x174>
     ...
     3a8:	f1c50513          	addi	a0,a0,-228 # 12c0 <thread_join+0x144>
     ...
     3e8:	f2450513          	addi	a0,a0,-220 # 1308 <thread_join+0x18c>
     ...
     404:	f2058593          	addi	a1,a1,-224 # 1320 <thread_join+0x1a4>
     ...
     434:	ef850513          	addi	a0,a0,-264 # 1328 <thread_join+0x1ac>
     438:	33f000ef          	jal	f76 <printf>
     43c:	bfe9                	j	416 <go+0x3a2>
          printf("grind: pipe read failed\n");
     43e:	00001517          	auipc	a0,0x1
     442:	f0a50513          	addi	a0,a0,-246 # 1348 <thread_join+0x1cc>
     446:	331000ef          	jal	f76 <printf>
     44a:	b7c5                	j	42a <go+0x3b6>
        printf("grind: fork failed\n");
     44c:	00001517          	auipc	a0,0x1
     450:	e7450513          	addi	a0,a0,-396 # 12c0 <thread_join+0x144>
     ...
     474:	e6850513          	addi	a0,a0,-408 # 12d8 <thread_join+0x15c>
     478:	726000ef          	jal	b9e <unlink>
        mkdir("a");
     47c:	00001517          	auipc	a0,0x1
     480:	e5c50513          	addi	a0,a0,-420 # 12d8 <thread_join+0x15c>
     484:	732000ef          	jal	bb6 <mkdir>
        chdir("a");
     488:	00001517          	auipc	a0,0x1
     48c:	e5050513          	addi	a0,a0,-432 # 12d8 <thread_join+0x15c>
     490:	72e000ef          	jal	bbe <chdir>
        unlink("../a");
     494:	00001517          	auipc	a0,0x1
     498:	ed450513          	addi	a0,a0,-300 # 1368 <thread_join+0x1ec>
     49c:	702000ef          	jal	b9e <unlink>
        fd = open("x", O_CREATE|O_RDWR);
     4a0:	20200593          	li	a1,514
     4a4:	00001517          	auipc	a0,0x1
     4a8:	e7c50513          	addi	a0,a0,-388 # 1320 <thread_join+0x1a4>
     4ac:	6e2000ef          	jal	b8e <open>
        unlink("x");
     4b0:	00001517          	auipc	a0,0x1
     4b4:	e7050513          	addi	a0,a0,-400 # 1320 <thread_join+0x1a4>
     ...
     4c6:	dfe50513          	addi	a0,a0,-514 # 12c0 <thread_join+0x144>
     ...
     4d8:	e9c50513          	addi	a0,a0,-356 # 1370 <thread_join+0x1f4>
     ...
     4e8:	e8c50513          	addi	a0,a0,-372 # 1370 <thread_join+0x1f4>
     ...
     4fc:	e2858593          	addi	a1,a1,-472 # 1320 <thread_join+0x1a4>
     ...
     536:	e3e50513          	addi	a0,a0,-450 # 1370 <thread_join+0x1f4>
     53a:	664000ef          	jal	b9e <unlink>
     53e:	b6f1                	j	10a <go+0x96>
        printf("grind: create c failed\n");
     540:	00001517          	auipc	a0,0x1
     544:	e3850513          	addi	a0,a0,-456 # 1378 <thread_join+0x1fc>
     ...
     556:	e3e50513          	addi	a0,a0,-450 # 1390 <thread_join+0x214>
     ...
     568:	e4450513          	addi	a0,a0,-444 # 13a8 <thread_join+0x22c>
     ...
     57c:	e4850513          	addi	a0,a0,-440 # 13c0 <thread_join+0x244>
     ...
     58e:	e5e50513          	addi	a0,a0,-418 # 13e8 <thread_join+0x26c>
     ...
     63c:	e5058593          	addi	a1,a1,-432 # 1488 <thread_join+0x30c>
     ...
     652:	cba58593          	addi	a1,a1,-838 # 1308 <thread_join+0x18c>
     656:	4509                	li	a0,2
     ...
     666:	ca658593          	addi	a1,a1,-858 # 1308 <thread_join+0x18c>
     66a:	4509                	li	a0,2
     ...
     6a6:	d6e58593          	addi	a1,a1,-658 # 1410 <thread_join+0x294>
     6aa:	4509                	li	a0,2
     ...
     702:	bc258593          	addi	a1,a1,-1086 # 12c0 <thread_join+0x144>
     706:	4509                	li	a0,2
     ...
     736:	cde58593          	addi	a1,a1,-802 # 1410 <thread_join+0x294>
     73a:	4509                	li	a0,2
     ...
     766:	cae58593          	addi	a1,a1,-850 # 1410 <thread_join+0x294>
     76a:	4509                	li	a0,2
     ...
     7b6:	b0e58593          	addi	a1,a1,-1266 # 12c0 <thread_join+0x144>
     7ba:	4509                	li	a0,2
     ...
     7d4:	cc050513          	addi	a0,a0,-832 # 1490 <thread_join+0x314>
...
iter()
{
  ...
  unlink("a");
     ...
     7ee:	aee50513          	addi	a0,a0,-1298 # 12d8 <thread_join+0x15c>
     7f2:	3ac000ef          	jal	b9e <unlink>
  unlink("b");
     7f6:	00001517          	auipc	a0,0x1
     7fa:	a9250513          	addi	a0,a0,-1390 # 1288 <thread_join+0x10c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     830:	a9450513          	addi	a0,a0,-1388 # 12c0 <thread_join+0x144>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     854:	629c                	ld	a5,0(a3)
     856:	6709                	lui	a4,0x2
     858:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x6b9>
    ...
    printf("grind: fork failed\n");
     ...
     86a:	a5a50513          	addi	a0,a0,-1446 # 12c0 <thread_join+0x144>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c3e:	91650513          	addi	a0,a0,-1770 # 1550 <digits>
     c42:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     ed4:	680b8b93          	addi	s7,s7,1664 # 1550 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     f22:	59a90913          	addi	s2,s2,1434 # 14b8 <thread_join+0x33c>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  if (stack == 0) {
    113c:	c105                	beqz	a0,115c <thread_create+0x3a>
    113e:	86aa                	mv	a3,a0
  ...
  int tid = clone(start_routine, arg1, arg2, stack);
    ...
    1142:	85ca                	mv	a1,s2
    1144:	8526                	mv	a0,s1
    1146:	aa9ff0ef          	jal	bee <clone>

  if (tid < 0) {
    114a:	02054163          	bltz	a0,116c <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
  ...
  return tid;
    ...
    1156:	69a2                	ld	s3,8(sp)
    1158:	6145                	addi	sp,sp,48
    115a:	8082                	ret
    printf("stack allocation failed\n");
    115c:	00000517          	auipc	a0,0x0
    1160:	36450513          	addi	a0,a0,868 # 14c0 <thread_join+0x344>
    1164:	e13ff0ef          	jal	f76 <printf>
    return -1;
    1168:	557d                	li	a0,-1
    116a:	b7d5                	j	114e <thread_create+0x2c>
    printf("clone failed\n");
    116c:	00000517          	auipc	a0,0x0
    1170:	37450513          	addi	a0,a0,884 # 14e0 <thread_join+0x364>
    1174:	e03ff0ef          	jal	f76 <printf>
    return -1;
    1178:	557d                	li	a0,-1
    117a:	bfd1                	j	114e <thread_create+0x2c>

000000000000117c <thread_join>:
...
int thread_join(){
  ...
  int pid = join(&stack);
    1186:	fd840513          	addi	a0,s0,-40
    118a:	a6dff0ef          	jal	bf6 <join>

  if (pid < 0)
    118e:	00054d63          	bltz	a0,11a8 <thread_join+0x2c>
    1192:	84aa                	mv	s1,a0
    return -1;

  free(stack);
    1194:	fd843503          	ld	a0,-40(s0)
    1198:	e11ff0ef          	jal	fa8 <free>

  return pid;
    119c:	8526                	mv	a0,s1
    119e:	70a2                	ld	ra,40(sp)
    11a0:	7402                	ld	s0,32(sp)
    11a2:	64e2                	ld	s1,24(sp)
    11a4:	6145                	addi	sp,sp,48
    11a6:	8082                	ret
    return -1;
    11a8:	54fd                	li	s1,-1
    11aa:	bfcd                	j	119c <thread_join+0x20>
