...
main(int argc, char *argv[])
{
  ...
  56:	8f658593          	addi	a1,a1,-1802 # 948 <thread_join+0x4a>
  5a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	5e450513          	addi	a0,a0,1508 # 9a0 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 656:	34eb8b93          	addi	s7,s7,846 # 9a0 <digits>
 ...
 6a4:	2c890913          	addi	s2,s2,712 # 968 <thread_join+0x6a>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 8e2:	09250513          	addi	a0,a0,146 # 970 <thread_join+0x72>
 ...
 8f2:	0a250513          	addi	a0,a0,162 # 990 <thread_join+0x92>
