...
main(void)
{
  ...
  12:	98250513          	addi	a0,a0,-1662 # 990 <thread_join+0x3c>
  ...
  2e:	96e90913          	addi	s2,s2,-1682 # 998 <thread_join+0x44>
  32:	854a                	mv	a0,s2
  ...
  56:	99650513          	addi	a0,a0,-1642 # 9e8 <thread_join+0x94>
  ...
  6c:	92850513          	addi	a0,a0,-1752 # 990 <thread_join+0x3c>
  70:	2fe000ef          	jal	36e <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	91a50513          	addi	a0,a0,-1766 # 990 <thread_join+0x3c>
  7e:	2e8000ef          	jal	366 <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	92c50513          	addi	a0,a0,-1748 # 9b0 <thread_join+0x5c>
  ...
  a2:	92a50513          	addi	a0,a0,-1750 # 9c8 <thread_join+0x74>
  a6:	2b8000ef          	jal	35e <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	92650513          	addi	a0,a0,-1754 # 9d0 <thread_join+0x7c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	62e50513          	addi	a0,a0,1582 # a40 <digits>
 41a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fa:	31290913          	addi	s2,s2,786 # a08 <thread_join+0xb4>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 900:	ec26                	sd	s1,24(sp)
 902:	e84a                	sd	s2,16(sp)
 904:	e44e                	sd	s3,8(sp)
 ...
 910:	ef3ff0ef          	jal	802 <malloc>
  ...
  if (stack == 0) {
 914:	c105                	beqz	a0,934 <thread_create+0x3a>
 916:	86aa                	mv	a3,a0
 ...
 91a:	85ca                	mv	a1,s2
 91c:	8526                	mv	a0,s1
 91e:	aa9ff0ef          	jal	3c6 <clone>

  if (tid < 0) {
 922:	02054163          	bltz	a0,944 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 938:	0dc50513          	addi	a0,a0,220 # a10 <thread_join+0xbc>
 93c:	e13ff0ef          	jal	74e <printf>
    return -1;
 940:	557d                	li	a0,-1
 942:	b7d5                	j	926 <thread_create+0x2c>
    printf("clone failed\n");
 944:	00000517          	auipc	a0,0x0
 948:	0ec50513          	addi	a0,a0,236 # a30 <thread_join+0xdc>
 94c:	e03ff0ef          	jal	74e <printf>
    return -1;
 950:	557d                	li	a0,-1
 952:	bfd1                	j	926 <thread_create+0x2c>

0000000000000954 <thread_join>:
...
int thread_join(){
 ...
 95c:	1800                	addi	s0,sp,48
  ...
  int pid = join(&stack);
 95e:	fd840513          	addi	a0,s0,-40
 962:	a6dff0ef          	jal	3ce <join>

  if (pid < 0)
 966:	00054d63          	bltz	a0,980 <thread_join+0x2c>
 96a:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 96c:	fd843503          	ld	a0,-40(s0)
 970:	e11ff0ef          	jal	780 <free>
 ...
 97e:	8082                	ret
    return -1;
 980:	54fd                	li	s1,-1
 982:	bfcd                	j	974 <thread_join+0x20>
