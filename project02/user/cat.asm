...
cat(int fd)
{
  ...
  3c:	98858593          	addi	a1,a1,-1656 # 9c0 <thread_join+0x3e>
  40:	4509                	li	a0,2
  ...
  62:	97a58593          	addi	a1,a1,-1670 # 9d8 <thread_join+0x56>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  da:	91a58593          	addi	a1,a1,-1766 # 9f0 <thread_join+0x6e>
  de:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 444:	60050513          	addi	a0,a0,1536 # a40 <digits>
 448:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6da:	36ab8b93          	addi	s7,s7,874 # a40 <digits>
 ...
 728:	2e490913          	addi	s2,s2,740 # a08 <thread_join+0x86>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 93e:	ef3ff0ef          	jal	830 <malloc>
  ...
  if (stack == 0) {
 942:	c105                	beqz	a0,962 <thread_create+0x3a>
 944:	86aa                	mv	a3,a0
 ...
 948:	85ca                	mv	a1,s2
 94a:	8526                	mv	a0,s1
 94c:	aa9ff0ef          	jal	3f4 <clone>

  if (tid < 0) {
 950:	02054163          	bltz	a0,972 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 966:	0ae50513          	addi	a0,a0,174 # a10 <thread_join+0x8e>
 96a:	e13ff0ef          	jal	77c <printf>
    return -1;
 96e:	557d                	li	a0,-1
 970:	b7d5                	j	954 <thread_create+0x2c>
    printf("clone failed\n");
 972:	00000517          	auipc	a0,0x0
 976:	0be50513          	addi	a0,a0,190 # a30 <thread_join+0xae>
 97a:	e03ff0ef          	jal	77c <printf>
    return -1;
 97e:	557d                	li	a0,-1
 980:	bfd1                	j	954 <thread_create+0x2c>

0000000000000982 <thread_join>:
...
int thread_join(){
 ...
 98a:	1800                	addi	s0,sp,48
  ...
  int pid = join(&stack);
 98c:	fd840513          	addi	a0,s0,-40
 990:	a6dff0ef          	jal	3fc <join>

  if (pid < 0)
 994:	00054d63          	bltz	a0,9ae <thread_join+0x2c>
 998:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 99a:	fd843503          	ld	a0,-40(s0)
 99e:	e11ff0ef          	jal	7ae <free>
 ...
 9ac:	8082                	ret
    return -1;
 9ae:	54fd                	li	s1,-1
 9b0:	bfcd                	j	9a2 <thread_join+0x20>
