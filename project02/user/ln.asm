...
main(int argc, char *argv[])
{
  ...
  14:	91058593          	addi	a1,a1,-1776 # 920 <thread_join+0x3a>
  18:	4509                	li	a0,2
  ...
  42:	8fa58593          	addi	a1,a1,-1798 # 938 <thread_join+0x52>
  46:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a8:	5e450513          	addi	a0,a0,1508 # 988 <digits>
 3ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 63e:	34eb8b93          	addi	s7,s7,846 # 988 <digits>
 ...
 68c:	2c890913          	addi	s2,s2,712 # 950 <thread_join+0x6a>
        for(; *s; s++)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 8a2:	ef3ff0ef          	jal	794 <malloc>
  ...
  if (stack == 0) {
 8a6:	c105                	beqz	a0,8c6 <thread_create+0x3a>
 8a8:	86aa                	mv	a3,a0
 ...
 8ac:	85ca                	mv	a1,s2
 8ae:	8526                	mv	a0,s1
 8b0:	aa9ff0ef          	jal	358 <clone>

  if (tid < 0) {
 8b4:	02054163          	bltz	a0,8d6 <thread_create+0x4a>
    printf("clone failed\n");
    return -1;
  }
 ...
 8be:	6942                	ld	s2,16(sp)
 8c0:	69a2                	ld	s3,8(sp)
 8c2:	6145                	addi	sp,sp,48
 8c4:	8082                	ret
    printf("stack allocation failed\n");
 8c6:	00000517          	auipc	a0,0x0
 8ca:	09250513          	addi	a0,a0,146 # 958 <thread_join+0x72>
 8ce:	e13ff0ef          	jal	6e0 <printf>
    return -1;
 8d2:	557d                	li	a0,-1
 8d4:	b7d5                	j	8b8 <thread_create+0x2c>
    printf("clone failed\n");
 8d6:	00000517          	auipc	a0,0x0
 8da:	0a250513          	addi	a0,a0,162 # 978 <thread_join+0x92>
 8de:	e03ff0ef          	jal	6e0 <printf>
    return -1;
 8e2:	557d                	li	a0,-1
 8e4:	bfd1                	j	8b8 <thread_create+0x2c>

00000000000008e6 <thread_join>:
...
int thread_join(){
 ...
 8ee:	1800                	addi	s0,sp,48
  ...
  int pid = join(&stack);
 8f0:	fd840513          	addi	a0,s0,-40
 8f4:	a6dff0ef          	jal	360 <join>

  if (pid < 0)
 8f8:	00054d63          	bltz	a0,912 <thread_join+0x2c>
 8fc:	84aa                	mv	s1,a0
    return -1;

  free(stack);
 8fe:	fd843503          	ld	a0,-40(s0)
 902:	e11ff0ef          	jal	712 <free>
 ...
 910:	8082                	ret
    return -1;
 912:	54fd                	li	s1,-1
 914:	bfcd                	j	906 <thread_join+0x20>
