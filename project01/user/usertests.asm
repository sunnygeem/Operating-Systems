...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4efc:	00003797          	auipc	a5,0x3
    4f00:	5547b783          	ld	a5,1364(a5) # 8450 <freep>
    ...
    4f28:	00e6ea63          	bltu	a3,a4,4f3c <free+0x4a>
{
  ...
  freep = p;
    ...
    4f6a:	4ef73523          	sd	a5,1258(a4) # 8450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4f94:	4c053503          	ld	a0,1216(a0) # 8450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    4fc0:	00003917          	auipc	s2,0x3
    4fc4:	49090913          	addi	s2,s2,1168 # 8450 <freep>
  if(p == (char*)-1)
    4fc8:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    4fd4:	0000a797          	auipc	a5,0xa
    4fd8:	ca478793          	addi	a5,a5,-860 # ec78 <base>
    4fdc:	00003717          	auipc	a4,0x3
    4fe0:	46f73a23          	sd	a5,1140(a4) # 8450 <freep>
  ...
  if(p == (char*)-1)
    ...
    5046:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    504a:	00003717          	auipc	a4,0x3
    504e:	40a73323          	sd	a0,1030(a4) # 8450 <freep>
      return (void*)(p + 1);
